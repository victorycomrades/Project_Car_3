...
message(STATUS "serial_comm: 1 messages, 0 services")

set(MSG_I_FLAGS "-Iserial_comm:/home/xrobot/xrobot3_ws/src/serial_comm/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/xrobot/xrobot3_ws/src/serial_comm/msg/RobotControl.msg" NAME_WE)
add_custom_target(_serial_comm_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "serial_comm" "/home/xrobot/xrobot3_ws/src/serial_comm/msg/RobotControl.msg" ""
)
...
_generate_msg_cpp(serial_comm
  "/home/xrobot/xrobot3_ws/src/serial_comm/msg/RobotControl.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(TARGET std_msgs_generate_messages_eus)
  add_dependencies(serial_comm_generate_messages_eus std_msgs_generate_messages_eus)
endif()
...
if(TARGET std_msgs_generate_messages_nodejs)
  add_dependencies(serial_comm_generate_messages_nodejs std_msgs_generate_messages_nodejs)
endif()

if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/serial_comm)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/serial_comm\")")
  # install generated code
  install(
