...
if("TRUE" STREQUAL "TRUE")
  set(navi_multi_goals_pub_rviz_plugin_SOURCE_PREFIX /home/xrobot/xrobot3_ws/src/third_packages/navi_multi_goals_pub_rviz_plugin)
  set(navi_multi_goals_pub_rviz_plugin_DEVEL_PREFIX /home/xrobot/xrobot3_ws/devel)
  ...
  set(navi_multi_goals_pub_rviz_plugin_INSTALL_PREFIX /home/xrobot/xrobot3_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'navi_multi_goals_pub_rviz_plugin' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/xrobot/xrobot3_ws/src/third_packages/navi_multi_goals_pub_rviz_plugin/${idir}'.  ${_report}")
    endif()
