...
echo_and_run cd "/home/xrobot/xrobot2_ws/src/third_packages/rosserial/rosserial_client"
...
echo_and_run /usr/bin/env \
    ...
    "/home/xrobot/xrobot2_ws/src/third_packages/rosserial/rosserial_client/setup.py" \
     \
    build --build-base "/home/xrobot/xrobot2_ws/build/third_packages/rosserial/rosserial_client" \
    install \
    --root="${DESTDIR-/}" \
