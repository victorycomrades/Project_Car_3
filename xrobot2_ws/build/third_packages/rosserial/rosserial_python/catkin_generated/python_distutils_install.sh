...
echo_and_run cd "/home/xrobot/xrobot2_ws/src/third_packages/rosserial/rosserial_python"
...
echo_and_run /usr/bin/env \
    ...
    "/home/xrobot/xrobot2_ws/src/third_packages/rosserial/rosserial_python/setup.py" \
     \
    build --build-base "/home/xrobot/xrobot2_ws/build/third_packages/rosserial/rosserial_python" \
    install \
    --root="${DESTDIR-/}" \
