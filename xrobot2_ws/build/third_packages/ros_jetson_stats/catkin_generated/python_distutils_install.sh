...
echo_and_run cd "/home/xrobot/xrobot2_ws/src/third_packages/ros_jetson_stats"
...
echo_and_run /usr/bin/env \
    ...
    "/home/xrobot/xrobot2_ws/src/third_packages/ros_jetson_stats/setup.py" \
     \
    build --build-base "/home/xrobot/xrobot2_ws/build/third_packages/ros_jetson_stats" \
    install \
    --root="${DESTDIR-/}" \
