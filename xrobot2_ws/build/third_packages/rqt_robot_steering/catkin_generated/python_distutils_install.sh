...
echo_and_run cd "/home/xrobot/xrobot2_ws/src/third_packages/rqt_robot_steering"
...
echo_and_run /usr/bin/env \
    ...
    "/home/xrobot/xrobot2_ws/src/third_packages/rqt_robot_steering/setup.py" \
     \
    build --build-base "/home/xrobot/xrobot2_ws/build/third_packages/rqt_robot_steering" \
    install \
    --root="${DESTDIR-/}" \
